...
Av CBC-solverens 18 kjøringer løste 9 *Optimal* innen 30-minuttersgrensen; de resterende 9 endte med *Not Solved*. Makespan-tallene er robuste også i Not Solved-variantene; omfordelings- og kartkontor-ferdigtallene har derimot lavere konfidens (drøftes samlet i 8.5). S5_Alle_minus50 gir en konkret indikasjon på hvor kartkontor-fasen begynner å nærme seg det kapasitetsbundne regimet: ferdigmåned 14 mot matematisk minimum 14,4 — ytterligere kutt under 50 % kapasitet ville med høy sannsynlighet tippe over i kartkontor-bundet regime.
